...
* **Cluster Configuration**
   ...
   * `everpure-moc` Pure storage configuration
      * [`ansible/group_vars/all/realms.yaml`](https://github.com/CCI-MOC/everpure-moc/blob/main/ansible/group_vars/all/realms.yaml) (search for `oac-prod-infra`)
   * `moc-aws` cluster certificates and external DNS configuration
      * [`main.tf`](https://github.com/CCI-MOC/moc-aws/blob/main/main.tf) (search for `oac_prod_infra`)
